  ...
  return `
    ...
    <html lang="en">
      ...
      <body>
        ...
        <h1>${title}</h1>
        <p>Assessment summary generated by Homewise on ${new Date().toLocaleDateString("en-US")}.</p>
        <p>
...
export default function CalculatorPage() {
  ...
  const exportAffordability = () => {
    ...
    openPdfExport("Homewise affordability summary", [
      {
        title: "Inputs",
        items: [
  ...
  const exportRefi = () => {
    ...
    openPdfExport("Homewise refi break-even summary", [
      {
        title: "Inputs",
        items: [
      ...
      <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2 sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm font-semibold tracking-tight">Homewise</div>
          </div>
